<template>
  <Layout>
    ...
    <div>
      <p class="home-links">
        <g-link class="link" to="/about/">À propos</g-link>
...
export default {
  metaInfo: {
    title: 'Bienvenue sur All&Surfing !'
  }
}
</script>
